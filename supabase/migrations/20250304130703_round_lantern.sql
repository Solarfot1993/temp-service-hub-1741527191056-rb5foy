...
ADD COLUMN IF NOT EXISTS lead_paid BOOLEAN DEFAULT false;
...
-- Create a function to decrement lead balance
CREATE OR REPLACE FUNCTION decrement_lead_balance(amount NUMERIC)
RETURNS NUMERIC AS $$
BEGIN
  RETURN lead_balance - amount;
END;
$$ LANGUAGE plpgsql;
